 ...
 * 
 */
@WebServiceClient(name = "CustomerServiceService", targetNamespace = "http://semesterarbeit.wi.mbg.de/", wsdlLocation = "http://localhost:8080/customerservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICESERVICE_QNAME = new QName("http://semesterarbeit.wi.mbg.de/", "CustomerServiceService");
    ...
    public CustomerService getCustomerServicePort() {
        return super.getPort(new QName("http://semesterarbeit.wi.mbg.de/", "CustomerServicePort"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://semesterarbeit.wi.mbg.de/", "CustomerServicePort"), CustomerService.class, features);
    }
